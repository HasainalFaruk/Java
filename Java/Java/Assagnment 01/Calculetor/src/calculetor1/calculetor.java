...
public class calculetor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BD.setForeground(new java.awt.Color(255, 0, 51));
        BD.setText("/");
        ...
        BCLR.setForeground(new java.awt.Color(255, 0, 102));
        BCLR.setText("CLR");
        ...
        BP.setForeground(new java.awt.Color(255, 0, 102));
        BP.setText(".");
        ...
        BPL.setForeground(new java.awt.Color(255, 0, 102));
        BPL.setText("+");
        ...
        BE.setBackground(new java.awt.Color(51, 0, 204));
        BE.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        BE.setForeground(new java.awt.Color(255, 0, 102));
        BE.setText("=");
        ...
        BM.setForeground(new java.awt.Color(255, 0, 51));
        BM.setText("-");
        ...
        BI.setForeground(new java.awt.Color(255, 0, 51));
        BI.setText("*");
